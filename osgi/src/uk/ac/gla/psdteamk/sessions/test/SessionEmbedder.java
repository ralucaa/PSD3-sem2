...
import uk.ac.gla.psdteamk.sessions.test.steps.*;

/**
 * Extends the default embedder class to customise settings for the stories.
 * @author tws
 *
 */
public class SessionEmbedder extends Embedder {
    ...
    public InjectableStepsFactory stepsFactory() {
        return
        	new InstanceStepsFactory(
        		...
        		new NFR_Performance0Steps(),
        		new NFR_Performance1Steps(),
        		new NFR_Performance2Steps(),
        		new NFR_Performance3Steps(),
        		new NFR_Performance4Steps(),
	...
	private StoryReporterBuilder getStoryReporterBuilder() {
        ...
        Class<? extends SessionEmbedder> embedderClass =
            this.getClass();
