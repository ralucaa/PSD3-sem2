...
public class NFR_Performance1 {
	...
	public void queryDatabase() {
		for (int i = 0; i < 10; i++) {
			output = (output && service.addSessionToDatabase(new Session((i*i + 1337), courseId, DateTimeOps.parseDateStringToJodaTime("2014-02-27"), DateTimeOps.parseTimeStringToJodaTime("00:00"), DateTimeOps.parseTimeStringToJodaTime("00:00"), 7, "BO505", 50, "testType")));
		}		 
	}
